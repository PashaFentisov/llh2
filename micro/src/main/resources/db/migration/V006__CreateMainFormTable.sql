...
(
    ...
    short_business_idea_description text         NOT NULL,
    business_manufacturing_place    text         NOT NULL,
    business_manufacturing_way      text         NOT NULL,
    business_consumers              text         NOT NULL,
    needed_grant_amount                           VARCHAR(500)  NOT NULL,
    grant_expenses                  text         NOT NULL,
    invested_money_amount           text         NOT NULL,
